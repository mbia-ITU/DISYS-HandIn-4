...
type PriorityReply struct {
	...
	IsPriority bool  `protobuf:"varint,1,opt,name=isPriority,proto3" json:"isPriority,omitempty"`
	Id         int32 `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"`
	Timestamp  int32 `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
}

func (x *PriorityReply) Reset() {
	*x = PriorityReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *PriorityReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PriorityReply) ProtoMessage() {}

func (x *PriorityReply) ProtoReflect() protoreflect.Message {
	mi := &file_communication_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PriorityReply.ProtoReflect.Descriptor instead.
func (*PriorityReply) Descriptor() ([]byte, []int) {
	return file_communication_proto_rawDescGZIP(), []int{1}
}

func (x *PriorityReply) GetIsPriority() bool {
	if x != nil {
		return x.IsPriority
	}
	return false
...
func (x *PriorityReply) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PriorityReply) GetTimestamp() int32 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_communication_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x70, 0x69, 0x6e, 0x67, 0x22, 0x21, 0x0a, 0x05, 0x52,
	...
	0x0a, 0x0d, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	0x1e, 0x0a, 0x0a, 0x69, 0x73, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12,
	...
	0x28, 0x05, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x37, 0x0a,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x5e, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x24,
	0x0a, 0x04, 0x70, 0x69, 0x6e, 0x67, 0x12, 0x0d, 0x2e, 0x70, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x70, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x22, 0x00, 0x12, 0x30, 0x0a, 0x08, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79,
	0x12, 0x0d, 0x2e, 0x70, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x13, 0x2e, 0x70, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x67, 0x52, 0x50, 0x43,
...
var file_communication_proto_goTypes = []interface{}{
	...
	(*PriorityReply)(nil), // 1: ping.priorityReply
	(*Request)(nil),       // 2: ping.Request
}
var file_communication_proto_depIdxs = []int32{
	2, // 0: ping.Ping.ping:input_type -> ping.Request
	2, // 1: ping.Ping.priority:input_type -> ping.Request
	0, // 2: ping.Ping.ping:output_type -> ping.Reply
	1, // 3: ping.Ping.priority:output_type -> ping.priorityReply
